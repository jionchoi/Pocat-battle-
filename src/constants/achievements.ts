 ...
 * ## The glyphs
 *
 * Ordinary app icons, not clever ones. Every entry used to wear the most *specific* glyph
 * Phosphor had for its sentence — a gauge for a score, a pair of binoculars for a discovery,
 * a house for a neighbourhood — and a column of them read as a stock icon sheet rather than
 * as a game: nothing on that list was a shape a player had pressed anywhere else. They are
 * now the vocabulary a phone already teaches. A camera means take a photo, a heart means
 * love, a map pin means you found somewhere, a share arrow means you posted it. Recognition
 * beats precision here, because the title beside the glyph is already carrying the precision.
 *
